...
void sorter()
{
    ...
    switch(choice)
    {
    	case 1: hostel=fopen("H-1.dat","a+");break;
    	case 2: hostel=fopen("H-2.dat","a+");break;
    	case 3: hostel=fopen("H-3.dat","a+");break;
    	case 4: hostel=fopen("H-4.dat","a+");break;
    	default: sorter();
    }
...
void new_entry()
{
    ...
    printf("\n Enter your room no.:");
    scanf("%s",add.room_no);
    printf("\n Enter your hostel name from H-1, H-2, H-3, H-4 :");
	...
	if(strcmp(add.hostel_name,"H-1")==0)
	{
		hostel=fopen("H-1.dat","a+");
		fprintf(hostel, "%s\n", add.roll_no);
		fclose(hostel);		
	}
	else if(strcmp(add.hostel_name,"H-2")==0)
	{
		hostel=fopen("H-2.dat","a+");
		fprintf(hostel, "%s\n", add.roll_no);
		fclose(hostel);		
	}
	else if(strcmp(add.hostel_name,"H-3")==0)
	{
		hostel=fopen("H-3.dat","a+");
		fprintf(hostel, "%s\n", add.roll_no);
		fclose(hostel);		
	}
	else if(strcmp(add.hostel_name,"H-4")==0)
	{
		hostel=fopen("H-4.dat","a+");
		fprintf(hostel, "%s\n", add.roll_no);
		fclose(hostel);		
	}
		//---------------------------------------- 
